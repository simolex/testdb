 ...
 * VerProcStages
 *
 * @ORM\Table(name="VER_PROC_STAGES", uniqueConstraints={@ORM\UniqueConstraint(name="fk$ver_proc_stages", columns={"PROC_ID", "STAGE_ID", "DB_NUM"})})
 * @ORM\Entity
 */
class VerProcStages
{
     ...
     * @ORM\SequenceGenerator(sequenceName="SEQ$VER_PROC_STAGES$ID", allocationSize=3, initialValue=3366)
     */
    private $id;
